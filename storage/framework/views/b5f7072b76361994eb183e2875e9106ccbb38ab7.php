...
<a href="<?php echo e(url($root)); ?>">Golongan</a>
<?php $__env->stopSection(); ?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" align="center">
                	<table class="table table-hover">
                        ...
                        <thead>
                		<tr>
                			<th><a href="<?php echo e(url('golongan/?sortBy=kode_golongan')); ?>">Kode</a></th>
                			<th><a href="<?php echo e(url('golongan/?sortBy=nama_golongan')); ?>">Nama</a></th>
                		...
                		<tr>
                            ...
                            <td class="action-web"><a href="<?php echo e(route('golongan.edit',$data->id)); ?>" class="btn btn-warning lebar">Edit</a></td>
                            <td class="action-web"><?php echo Form::open(['method'=> 'DELETE', 'route'=>['golongan.destroy',$data->id]]); ?>
                            ...
                            <td class="action-mobile dropdown" colspan="3">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="<?php echo e(route('golongan.edit',$data->id)); ?>">Edit</a></li>
                                </ul>
                            </td>
                		</tr>
                		<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
