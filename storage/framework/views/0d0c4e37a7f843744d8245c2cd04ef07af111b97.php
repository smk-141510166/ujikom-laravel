                ...
                <div class="panel-body" align="center">
                	<table class="table table-hover">
                		...
                		<tr>
                            ...
                            <td class="action-web"><a href="<?php echo e(route('tunjangan.edit',$data->id)); ?>" class="btn btn-warning lebar">Edit</a></td>
                            <td class="action-web"><?php echo Form::open(['method'=> 'DELETE', 'route'=>['tunjangan.destroy',$data->id]]); ?>
