            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" align="center">
                	<table class="table table-hover">
                		...
                		<tr>
                            <th>Tanggal</th>
                            <th><a href="<?php echo e(url('lembur_pegawai/?sortBy=pegawai_id')); ?>">Pegawai</a></th>
                		...
                		<tr>
                            <td><?php echo e($data->created_at->format('j F Y')); ?></td>
                            ...
                            <td class="action-web"><a href="<?php echo e(route('lembur_pegawai.edit',$data->id)); ?>" class="btn btn-warning lebar">Edit</a></td>
                            <td class="action-web"><?php echo Form::open(['method'=> 'DELETE', 'route'=>['lembur_pegawai.destroy',$data->id]]); ?>
                            ...
                            <td class="action-mobile dropdown" colspan="3">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="<?php echo e(route('lembur_pegawai.edit',$data->id)); ?>">Edit</a></li>
                                </ul>
                            </td>
                		</tr>
                		<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
