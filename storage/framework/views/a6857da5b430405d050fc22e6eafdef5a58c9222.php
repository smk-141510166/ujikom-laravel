...
<?php 
 ?>
<?php if(isset($pegawais->where('user_id',Auth::user()->id)->first()->id)): ?>
<?php 
...
<div class="row">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="panel-title" align="center">
					<img class="foto-profile" style="background-image: url(<?php echo e(url('account',$pegawai->foto)); ?>)">
				</div>
			</div>
			<div class="panel-body">
				<table class="table">
					<tr>
						<td>NIP</td>
						<td><?php echo Form::label('',$pegawai->nip,['class'=>'form-control']); ?></td>
					</tr>
					<tr>
						<td>Nama</td>
					...
					<tr>
						<td>Email</td>
						<td><?php echo Form::label('',$pegawai->user->email,['class'=>'form-control']); ?></td>
					</tr>
					<tr>
						<td>Jabatan</td>
						<td><?php echo Form::label('',$pegawai->jabatan->nama_jabatan,['class'=>'form-control']); ?></td>
					</tr>
					<tr>
						<td>Golongan</td>
						<td><?php echo Form::label('',$pegawai->golongan->nama_golongan,['class'=>'form-control']); ?></td>
					</tr>
				</table>
			</div>
		</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table class="table">
					<tr>
						<td>Jabatan</td>
						<td><?php echo Form::label('',$pegawai->jabatan->nama_jabatan); ?></td>
						<td><div class="input-group">
								<span class="input-group-addon">Rp.</span>
								<?php echo Form::label('tunjangan_uang',$gajijabatan,['class'=>'form-control','id'=>'appendprepend']); ?>

							</div></td>
					</tr>
					<tr>
						<td>Golongan</td>
						<td><?php echo Form::label('',$pegawai->golongan->nama_golongan); ?></td>
						<td><div class="input-group">
								<span class="input-group-addon">Rp.</span>
								<?php echo Form::label('tunjangan_uang',$gajigolongan,['class'=>'form-control','id'=>'appendprepend']); ?>
					...
					<tr>
						...
						<td><div class="input-group">
								<span class="input-group-addon">Rp.</span>
								<?php echo Form::label('',$gajipokok,['class'=>'form-control']); ?>

							</div></td>
					</tr>
				</table>
				<?php if(isset($pegawai->tunjangan_pegawai->kode_tunjangan_id)): ?>
				<?php if(isset($gajis->where('tunjangan_pegawai_id',$pegawai->tunjangan_pegawai->kode_tunjangan_id)->first()->id)): ?>
	...
	<?php $gajis = $gajis->where('tunjangan_pegawai_id',$pegawai->tunjangan_pegawai->kode_tunjangan_id); ?>
				<table class="table table-bordered table-hover">
					...
					<tbody>
						<?php $__currentLoopData = $gajis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gaji): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
							<tr>
								<td><?php echo e($gaji->created_at->format('F')); ?></td>
								<td><?php echo e($gaji->jumlah_jam_lembur); ?></td>
								<td><?php echo e(number_format($gaji->jumlah_uang_lembur,2,',','.')); ?></td>
								<td><?php echo e(number_format($gaji->total_gaji,2,',','.')); ?></td>
								<?php if($gaji->status_pengambilan == 0): ?>
								<td class="danger">Belum Diambil</td>
								<?php elseif($gaji->status_pengambilan == 1): ?>
				...
				<table class="table table-bordered table-hover">
					...
					<tbody>
						<tr>
							<td><?php echo e($lembur->created_at->format('l\\, j F Y')); ?></td>
							<td><?php echo e($lembur->jumlah_jam); ?></td>
							<td><?php echo e($lembur->jumlah_jam*$lembur->kategori_lembur->besaran_uang); ?></td>
						</tr>
					</tbody>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
				</table>
