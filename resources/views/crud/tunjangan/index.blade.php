                ...
                <div class="panel-body" align="center">
                	<table class="table table-hover">
                		...
                		<tr>
                            ...
                            <td class="action-web"><a href="{{route('tunjangan.edit',$data->id)}}" class="btn btn-warning lebar">Edit</a></td>
                            <td class="action-web">{!! Form::open(['method'=> 'DELETE', 'route'=>['tunjangan.destroy',$data->id]]) !!}
